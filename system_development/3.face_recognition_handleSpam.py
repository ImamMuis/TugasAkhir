    ...
    if succes:
        ...
        for x1, y1, w1, h1 in faces:
            ...
            if jumlahWajah > 1:
                ...
                if w1 <= jarakWajah[0] :
                    imgRGB = cv2.putText(imgRGB, 'Wajah terlalu jauh!', (15, 25), font, 0.7, (54, 67, 244), 2)
                
                elif w1 >= jarakWajah[1]:
                    imgRGB = cv2.putText(imgRGB, 'Wajah terlalu dekat!', (15, 25), font, 0.7, (54, 67, 244), 2)
                ...
                imgRGB = cv2.putText(imgRGB, confidenceText, (x2+w2-60, y2+h2-5), font, 0.7, (145, 202, 19), 2)
        ...
        if countFaceCompare == faceCompare:
            ...
            if DetectedFace_Last == 0 and DetectedFace_Now == 1:
                ...
                if TimeBetween > DetectedFace_Tolerance and faceState == True:
                    ...
                    telebotText = f'Tidak ada wajah  terdeteksi dalam {DetectedFace_Tolerance} detik terakhir'
                    bot.sendMessage(chat_id, telebotText)
...
print(telebotText)
bot.sendMessage(1338050139, telebotText)
